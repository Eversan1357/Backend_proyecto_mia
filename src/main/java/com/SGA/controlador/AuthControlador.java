...
public class AuthControlador {
	...
	public ResponseEntity<?> registrarUsuario(@RequestBody RegistroDto registroDto){
		...
		Municipio unMunicipio =  municipioRepository.getById(registroDto.getUnaPersona().getLugarDeNacimiento().getId_Municipio());
		...
		unaPersona.setFechaModificacion(null);
    ...
    private void enviarNuevoPasswordCorreoElectronico(Usuario unUsuario,String password){
       ...
       String mensaje =
             ...
             +"<br><br><img src = 'https://i.ibb.co/1rKjSSB/FUNDACIONMIACONSTRUYENDOFUTURO.png' with='300px' height='220px'/>";
